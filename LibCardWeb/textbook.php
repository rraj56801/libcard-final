<?php
	...
	$error = false;
			$ress = mysqli_query($con,"SELECT * FROM booklist WHERE textBook IS NOT NULL");
	...
	if (isset($_POST['btn_search']) ) {
		...
		if (empty($libId)) {
			$error = true;
			$libIdSearchError = "Please select your course.";
		} 	
	}else{
					...
					<div class="box-content">
						<form class="form-horizontal"  method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
							<fieldset>
								...
								<div class="controls">
								  <select id="selectError" style="width: 150px" data-rel="chosen" name='libId'>
									<option></option>
         ...
         <button type="submit" class="btn btn-primary" name="btn_search">Search</button>
			...
			<div class="control-group">
			 ...
			 <div class="control-group">
			  	  ...
			  	  <?php include_once 'display_textbook.php' ?>
					
							  <hr />				
			  	  <?php include_once 'display_all.php' ?>
