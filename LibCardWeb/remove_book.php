...
if (isset($_POST['btn_submit']) ) {
		...
		$libIdS = trim($_POST['libIdS']);
		$libIdS = strip_tags($libIdS);
		$libIdS = htmlspecialchars($libIdS);
		// basic name validation
		if (empty($libIdS)) {
			$error = true;
			$libIdError = "Please enter book Id.";
		} 	
	if( !$error ) {
			$ress = mysqli_query($con,"DELETE FROM booklist WHERE bookId='$libIdS'");
...
<body>
	...
	<?php include_once 'display_bookdetails.php' ?>
	<span class="text-danger"><?php echo $libIdSearchError; ?></span>
...
input[type=text]:focus {
    width: 50%;
    	...
    	<h3>Book Id Here...  
                ...
                <span class="input-group-addon"><span class="glyphicon glyphicon-search"></span></span>	
    	<div>
    	<input type="text" name="libIdS" placeholder="Submit...">
